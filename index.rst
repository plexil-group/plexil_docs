...
`VxWorks <http://www.windriver.com>`_ embedded operating system, and a
...
PLEXIL has been used to model automation for International Space
Station operations, in a simulation setting.
