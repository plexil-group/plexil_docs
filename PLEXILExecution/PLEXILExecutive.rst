...
If your plan uses libraries (discussed in :ref:`Plexil Reference
<PlexilReference>`), they may be specified as well. In the following
example, assume two library files named ``lib1.plx`` and ``lib2.plx``.
